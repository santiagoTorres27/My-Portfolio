export const projectList = [
  {
    ...
    title: "HelpPet",
    description:
      "HelpPet is a web application for pet adoption. Animals of all kinds can find a new home.",
    ...
    features: [
      {
        feature: "Login, Logout and Signup using Firebase",
      },
      {
        feature: "Posts of pets with the most relevant data of the animal",
      },
      {
        feature: "Comments for each publication of a pet",
      },
      {
        feature: "Contact with the different owners of the published pets",
      },
    ],
    links: [
      {
  ...
  },
  {
    ...
    features: [
      {
        feature: "Create, update and delete tasks",
      },
      {
        feature: "Keep track of progress",
      },
      {
  ...
  },
  {
    ...
    title: "FavorLoop",
    description:
      "FavorLoop is an app to request and receive help from other people. Make a post and someone will help you",
    ...
    descriptionLarge:
      "FavorLoop is an app to request and receive help from other people. Post a 'Loop' requesting help and someone will respond to you. Create events to bring groups of people together for community activities.",
    technologyUsed: [
      {
        name: "Java",
      ...
      {
        name: "Android Studio",
        icon: "./img/skills/android.svg",
      },
    ],
    features: [
      {
        feature: "Post 'loops' to ask other people for help",
      },
      {
  ...
  },
  {
    id: "goality",
    title: "Goality",
    description: "Goality is a football team and player management app.",
    ...
    features: [
      {
        feature: "Monitoring of matches and results",
      },
      {
        feature: "Control of team members",
      },
      {
        feature: "Control and organization of training sessions",
      },
    ],
    links: [
      {
  ...
  },
  {
    ...
    title: "Memory Game",
    description:
      "Android game that consists of finding pairs of images using and exercising memory.",
  ...
  },
  {
    ...
    description:
      "Android application focused on the use of the Pomodoro technique to obtain the highest possible productivity",
